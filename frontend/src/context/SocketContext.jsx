...
export const SocketProvider = ({ children }) => {
  ...
  useEffect(() => {
    // Connect to socket server - use env variable for deployment
    // In production, if no env var is set, use the current page origin
    const getSocketUrl = () => {
      if (import.meta.env.VITE_SOCKET_URL) {
        return import.meta.env.VITE_SOCKET_URL;
      }
      // In production (not localhost), use same origin as the page
    ...
    console.log('[SocketContext] Using socket URL:', SOCKET_URL);
