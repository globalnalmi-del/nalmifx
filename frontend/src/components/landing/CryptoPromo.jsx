    ...
    <section className="relative w-full min-h-[720px] lg:h-[840px] flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          ...
          alt="Metallic chain detail for NalmiFx Crypto"
      ...
      {/* Content Container */}
      <div className="relative z-10 w-full max-w-[1440px] mx-auto px-6 md:px-[60px]">
        <div className="max-w-[480px]">
          ...
          <div className="mb-8 flex items-center gap-2">
            ...
            <span className="text-white text-[24px]" style={{ fontFamily: "'Playfair Display', serif" }}>NalmiFx Crypto</span>
          </div>

          {/* Headline */}
          <h1 
            className="text-white mb-6 leading-[1.1] tracking-[-0.02em]"
            style={{ 
