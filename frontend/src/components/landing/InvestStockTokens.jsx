      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-[60px] py-20 md:py-[140px]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-[120px] items-start">
          ...
          <div className="flex flex-col max-w-[480px]">
            {/* Label */}
            <h3 className="text-[18px] font-medium leading-[1.2] mb-6 tracking-tight opacity-80">
              Invest
            </h3>

            {/* Headline */}
            <h2 
              className="text-[48px] md:text-[64px] font-light leading-[1.1] mb-8 tracking-[-0.02em]"
            ...
            <div className="mb-20">
              <a
                href="#"
                className="inline-block bg-black text-white px-8 py-[14px] rounded-[24px] font-medium text-[16px] hover:opacity-90 transition-opacity"
              >
                Learn more
              </a>
            </div>
