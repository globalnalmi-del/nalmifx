...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#CFF12F] text-[#000000] py-14 px-6 md:px-[60px]" style={{ fontFamily: "'Inter', sans-serif" }}>
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6 text-[12px] leading-[1.6]">
            ...
            <p>
              NalmiFX Europe, UAB ("NFX" or "NalmiFX") (company code: 306377915) is authorized and regulated by the Bank of Lithuania ("BoL") as a financial brokerage firm and a crypto-asset service provider. NFX is an affiliated entity and wholly owned subsidiary of NalmiFX Markets, Inc. ("Parent Company"). NFX's registered address is: Vilniaus g. 33-201, LT-01402 Vilnius, Lithuania.
            </p>
            <p className="font-mono">5070830</p>
            <p>
              NalmiFX Markets, Inc. © 2025 NalmiFX. All rights reserved.
            </p>
          </div>
        </div>
        ...
        <div className="mt-20 flex justify-center overflow-hidden select-none pointer-events-none">
          <h1 
            className="text-[20vw] lg:text-[23.5vw] font-medium leading-[0.8]  tracking-tighter"
