...
const TradingAccounts = ({ onOpenTrading }) => {
  ...
  const filteredAccounts = accounts.filter(acc => {
    if (activeTab === 'real') return !acc.isDemo && !acc.isChallenge && acc.status === 'active'
                ...
                >
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center gap-1.5 mb-4">
                      ...
                      <span className="text-xs font-medium" style={{ color: account.isChallenge ? '#f59e0b' : account.status === 'active' ? '#22c55e' : 'var(--text-muted)' }}>
                        {account.isChallenge ? 'Challenge' : account.isDemo ? 'Demo' : 'Live'}
                      </span>
                    </div>
