...
import { Login, Signup, AdminLogin, VerifyEmail, VerifyOTP } from './components/auth'
        ...
        <SocketProvider>
          <BrowserRouter>
            <Routes>
              ...
              {/* Prop Firm Challenge Routes */}
              <Route path="/prop-firm" element={<ProtectedRoute><App initialView="propfirm" /></ProtectedRoute>} />
              ...
              <Route path="/admin/propfirm" element={<AdminProtectedRoute><AdminPanel initialSection="propfirm" /></AdminProtectedRoute>} />
              ...
              <Route path="/admin/emailtemplates" element={<AdminProtectedRoute><AdminPanel initialSection="emailtemplates" /></AdminProtectedRoute>} />
