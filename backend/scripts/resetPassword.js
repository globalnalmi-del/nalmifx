#!/usr/bin/env node
/**
 * Password Reset Utility for NalmiFX
 * 
 * Usage:
 *   node scripts/resetPassword.js --type admin --email admin@nalmifx.com --password NewPassword123
...
async function main() {
  ...
  if (!type || !email || !password) {
    console.log(`
NalmiFx Password Reset Utility
==============================

Usage:
  Reset admin password:
    node scripts/resetPassword.js --type admin --email admin@nalmifx.com --password Admin@123
