...
router.get('/instruments', async (req, res) => {
  try {
    const instruments = [
      ...
      // Exotic Pairs
      { symbol: 'USDSGD', name: 'USD/SGD', category: 'forex', segment: 'exotic', pip: 0.0001, contractSize: 100000 },
      { symbol: 'USDHKD', name: 'USD/HKD', category: 'forex', segment: 'exotic', pip: 0.0001, contractSize: 100000 },
      { symbol: 'USDMXN', name: 'USD/MXN', category: 'forex', segment: 'exotic', pip: 0.0001, contractSize: 100000 },
      { symbol: 'USDZAR', name: 'USD/ZAR', category: 'forex', segment: 'exotic', pip: 0.0001, contractSize: 100000 },
      { symbol: 'USDTRY', name: 'USD/TRY', category: 'forex', segment: 'exotic', pip: 0.0001, contractSize: 100000 },
      { symbol: 'USDSEK', name: 'USD/SEK', category: 'forex', segment: 'exotic', pip: 0.0001, contractSize: 100000 },
      { symbol: 'USDNOK', name: 'USD/NOK', category: 'forex', segment: 'exotic', pip: 0.0001, contractSize: 100000 },
      { symbol: 'USDINR', name: 'USD/INR', category: 'forex', segment: 'exotic', pip: 0.0001, contractSize: 100000 },
      { symbol: 'EURTRY', name: 'EUR/TRY', category: 'forex', segment: 'exotic', pip: 0.0001, contractSize: 100000 },
      { symbol: 'EURPLN', name: 'EUR/PLN', category: 'forex', segment: 'exotic', pip: 0.0001, contractSize: 100000 },
      // Metals
      ...
      { symbol: 'XAUEUR', name: 'Gold/EUR', category: 'metals', segment: 'metals', pip: 0.1, contractSize: 100 },
      { symbol: 'XPTUSD', name: 'Platinum', category: 'metals', segment: 'metals', pip: 0.1, contractSize: 100 },
      { symbol: 'XPDUSD', name: 'Palladium', category: 'metals', segment: 'metals', pip: 0.1, contractSize: 100 },
      // Commodities - Energy
      { symbol: 'USOIL', name: 'WTI Crude Oil', category: 'commodities', segment: 'energy', pip: 0.01, contractSize: 1000 },
      { symbol: 'UKOIL', name: 'Brent Crude Oil', category: 'commodities', segment: 'energy', pip: 0.01, contractSize: 1000 },
      { symbol: 'XNGUSD', name: 'Natural Gas', category: 'commodities', segment: 'energy', pip: 0.001, contractSize: 10000 },
      // Commodities - Agriculture
      { symbol: 'COCOA', name: 'Cocoa', category: 'commodities', segment: 'agriculture', pip: 1, contractSize: 1 },
      { symbol: 'COFFEE', name: 'Coffee', category: 'commodities', segment: 'agriculture', pip: 0.01, contractSize: 1 },
      { symbol: 'COTTON', name: 'Cotton', category: 'commodities', segment: 'agriculture', pip: 0.01, contractSize: 1 },
      { symbol: 'SUGAR', name: 'Sugar', category: 'commodities', segment: 'agriculture', pip: 0.01, contractSize: 1 },
      { symbol: 'WHEAT', name: 'Wheat', category: 'commodities', segment: 'agriculture', pip: 0.01, contractSize: 1 },
      { symbol: 'CORN', name: 'Corn', category: 'commodities', segment: 'agriculture', pip: 0.01, contractSize: 1 },
      { symbol: 'SOYBEAN', name: 'Soybean', category: 'commodities', segment: 'agriculture', pip: 0.01, contractSize: 1 },
      // Crypto - Major
      ...
      // Crypto - Altcoins
      { symbol: 'BNBUSD', name: 'Binance Coin', category: 'crypto', segment: 'crypto', pip: 0.01, contractSize: 1 },
      { symbol: 'ADAUSD', name: 'Cardano', category: 'crypto', segment: 'crypto', pip: 0.0001, contractSize: 1 },
      { symbol: 'SOLUSD', name: 'Solana', category: 'crypto', segment: 'crypto', pip: 0.01, contractSize: 1 },
      { symbol: 'DOTUSD', name: 'Polkadot', category: 'crypto', segment: 'crypto', pip: 0.001, contractSize: 1 },
      { symbol: 'DOGEUSD', name: 'Dogecoin', category: 'crypto', segment: 'crypto', pip: 0.00001, contractSize: 1 },
      { symbol: 'MATICUSD', name: 'Polygon', category: 'crypto', segment: 'crypto', pip: 0.0001, contractSize: 1 },
      { symbol: 'LINKUSD', name: 'Chainlink', category: 'crypto', segment: 'crypto', pip: 0.001, contractSize: 1 },
      { symbol: 'AVAXUSD', name: 'Avalanche', category: 'crypto', segment: 'crypto', pip: 0.01, contractSize: 1 },
      { symbol: 'SHIBUSD', name: 'Shiba Inu', category: 'crypto', segment: 'crypto', pip: 0.00000001, contractSize: 1 },
      { symbol: 'UNIUSD', name: 'Uniswap', category: 'crypto', segment: 'crypto', pip: 0.001, contractSize: 1 },
      { symbol: 'ATOMUSD', name: 'Cosmos', category: 'crypto', segment: 'crypto', pip: 0.001, contractSize: 1 },
      { symbol: 'XLMUSD', name: 'Stellar', category: 'crypto', segment: 'crypto', pip: 0.0001, contractSize: 1 },
      { symbol: 'TRXUSD', name: 'Tron', category: 'crypto', segment: 'crypto', pip: 0.00001, contractSize: 1 },
      { symbol: 'NEARUSD', name: 'NEAR Protocol', category: 'crypto', segment: 'crypto', pip: 0.001, contractSize: 1 },
      { symbol: 'APTUSD', name: 'Aptos', category: 'crypto', segment: 'crypto', pip: 0.001, contractSize: 1 },
      // Indices
      ...
      { symbol: 'FRA40', name: 'CAC 40', category: 'indices', segment: 'indices', pip: 0.1, contractSize: 1 },
      { symbol: 'JP225', name: 'Nikkei 225', category: 'indices', segment: 'indices', pip: 1, contractSize: 1 },
      { symbol: 'AUS200', name: 'ASX 200', category: 'indices', segment: 'indices', pip: 0.1, contractSize: 1 },
      { symbol: 'HK50', name: 'Hang Seng', category: 'indices', segment: 'indices', pip: 1, contractSize: 1 },
      { symbol: 'CHINA50', name: 'China A50', category: 'indices', segment: 'indices', pip: 0.1, contractSize: 1 },
    ];
